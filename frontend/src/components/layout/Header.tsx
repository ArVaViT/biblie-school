    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm supports-[backdrop-filter]:bg-background/90">
      <div className="container mx-auto max-w-[1400px] px-4">
        <div className="flex h-12 items-center justify-between gap-3">
          <Link
            to="/"
            className="shrink-0 font-serif text-base font-semibold tracking-tight text-foreground transition-opacity hover:opacity-85"
          >
            {t("common.appName")}
          </Link>
          ...
          <div className="flex shrink-0 items-center gap-2">
            <div className="hidden items-center gap-1 md:flex">
              {user ? (
                ...
                <>
                  <Link to="/login">
                    <Button variant="ghost" size="sm" className="h-7 px-2.5 text-xs font-medium">
                      {t("common.signIn")}
                    </Button>
                  </Link>
                  <Link to="/register">
                    <Button size="sm" className="h-7 px-2.5 text-xs font-medium">
                      {t("common.register")}
                    </Button>
                  </Link>
                </>
            ...
            <div className="flex md:hidden">
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-8 min-w-8 px-1.5 text-muted-foreground hover:text-foreground"
